...
function helper.label(text, color)
  ...
  return '^fg(' .. color .. ')' .. ^fn(RobotoMono-8)text
end
...
function parts.host(colorBg)
  return _h.common('', ^fn(RobotoMono-8)'Host?', '$nodename', colorBg) 
end
