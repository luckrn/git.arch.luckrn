...
function get_params_top() {    
    ...
    local bgcolor="#212121"
    local fgcolor="#e0e0e0"
    # local font='-*-terminesspowerline-*-*-*-*-12-*-*-*-*-*-*-*'
    local font='RobotoMono:size=8'
...
# theme
readonly pre_icon="^fg(${color['grey800']})$font_awesome"
...
function output_by_tag() {
    ...
    local text_pre=''
    case $tag_mark in
        # '#') text_pre+="^bg(${color['blueluke']})^fg(${color['black']})"
        '#') text_pre+="^bg(${color['blueluke']})^fg(#212121)"
             text_pre+=$right_hard_arrow
             text_pre+="^bg(${color['blueluke']})^fg(${color['white']})"     
        ;;
    ...
    if [ $tag_mark = '#' ]
    then
        # text_post+="^bg(${color['black']})^fg(${color['blueluke']})"
        text_post+="^bg(#212121)^fg(${color['blueluke']})"
...
function set_datetime() {
    ...
    local time_text="$time_icon ^bg()^fg(${color['blueluke']}) $time_str"
