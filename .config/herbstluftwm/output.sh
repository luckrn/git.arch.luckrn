...
readonly tag_shows=( "0000" "0001" "0010" "0011" "0100")
...
readonly separator="^bg()^fg(#151515)|^bg()^fg()"
...
# readonly font_awesome="^fn(cursor-17)"

# theme
# readonly pre_icon="^fg(${color['yellow500']})$font_awesome"
readonly pre_icon="^fg(#505050)$font_awesome"
